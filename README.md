...
<p align="center">
	<img src="https://github.com/hnvn/flutter_image_cropper/blob/v2/image_cropper/screenshots/cropper_android.gif?raw=true" width="200"  />
</p>
...
<p align="center">
  <img src="https://github.com/hnvn/flutter_image_cropper/blob/v2/image_cropper/screenshots/cropper_ios.gif?raw=true" width="200" />
</p>
...
<p align="center">
  <img src="https://github.com/hnvn/flutter_image_cropper/blob/v2/image_cropper/screenshots/cropper_web.png?raw=true" width="400"/>
</p>
...
| `viewwMode`                | Define the view mode of the cropper. If you set `viewMode` to 0, the crop box can extend outside the canvas, while a value of 1, 2, or 3 will restrict the crop box to the size of the canvas. `viewMode` of 2 or 3 will additionally restrict the canvas to the container. There is no difference between 2 and 3 when the proportions of the canvas and the container are the same. Default = `0` | WebViewMode      |
| `dragMode`                 | Define the dragging mode of the cropper. Default = `crop`                                                                                                                                                                                                                                                                                                                                           | WebDragMode      |
